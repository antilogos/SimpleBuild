...
function pobNoteToHtml(div, str) {
    ...
    txt.innerHTML = str.trim().replaceAll("\n","<br/>")
		.replaceAll(/\^x([0-9A-Fa-f]{6})(.*?)\^7/g,"<color \"#$1\">$2</color>")
...
function clearProfile(divList) {
	if(divList == null) divList = [DIV_NOTES, DIV_SETUP, DIV_GEMCONFIGURATION, DIV_ROADMAP, DIV_POBCODE, DIV_ASCENDANCY, DIV_TREE, DIV_MASTERY, DIV_PREVIEW, DIV_KEYSTONE, DIV_PATHWAY, DIV_INVENTORYSET, 
