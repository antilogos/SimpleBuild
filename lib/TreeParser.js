...
function fetchTreeData(lang) {
	if(lang == "fr") {
		// Mine
		return fetch("https://raw.githubusercontent.com/antilogos/SimpleFiltre/master/TreeParser/data-328.json").then(response => response.json()).then(parsed => {
...
const classPosition = [{x:240,y:580},{x:660,y:240},{x:0,y:580},{x:740,y:0},{x:320,y:500},{x:480,y:580},{x:270,y:580}];
const ascendancyPosition = {'Ascendant':{x:220,y:180}, 'Juggernaut':{x:660,y:160}, 'Berserker':{x:330,y:340}, 'Chieftain':{x:110,y:500}, 'Raider':{x:660,y:400}, 'Deadeye':{x:190,y:500}, 'Pathfinder':{x:660,y:480}, 'Occultist':{x:660,y:400}, 'Elementalist':{x:350,y:500}, 'Necromancer':{x:660,y:320}, 'Slayer':{x:400,y:580}, 'Gladiator':{x:430,y:500}, 'Champion':{x:440,y:420}, 'Inquisitor':{x:660,y:80}, 'Hierophant':{x:660,y:0}, 'Guardian':{x:510,y:500}, 'Assassin':{x:330,y:260}, 'Trickster':{x:560,y:580}, 'Saboteur':{x:160,y:580}, 'Scion':{x:80,y:580}, 'Marauder':{x:660,y:240}, 'Ranger':{x:0,y:580}, 'Witch':{x:740,y:0}, 'Duelist':{x:270,y:500}, 'Templar':{x:480,y:580}, 'Shadow':{x:320,y:580}, 'Reliquarian':{'Saboteur':{x:80,y:580}}};
