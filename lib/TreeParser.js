...
function scaleZoom(viewport, treeNodes) {
	...
	let alignmentLeft = ((viewport.parentElement.getBoundingClientRect().width-(spanWidth*ratio))/2);
	let alignmentTop = ((viewport.parentElement.getBoundingClientRect().height-(spanHeight*ratio))/2);
