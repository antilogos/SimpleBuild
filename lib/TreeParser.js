...
const ascendancyPosition = {'Ascendant':{x:0,y:180}, 'Juggernaut':{x:440,y:80}, 'Berserker':{x:330,y:0}, 'Chieftain':{x:330,y:160}, 'Raider':{x:550,y:400}, 'Deadeye':{x:0,y:260}, 'Pathfinder':{x:0,y:420}, 'Occultist':{x:440,y:320}, 'Elementalist':{x:220,y:260}, 'Necromancer':{x:440,y:240}, 'Slayer':{x:550,y:160}, 'Gladiator':{x:0,y:340}, 'Champion':{x:330,y:80}, 'Inquisitor':{x:440,y:0}, 'Hierophant':{x:220,y:340}, 'Guardian':{x:110,y:340}, 'Assassin':{x:110,y:180}, 'Trickster':{x:550,y:320}, 'Saboteur':{x:330,y:420}, 'Scion':{x:550,y:0}, 'Marauder':{x:440,y:160}, 'Ranger':{x:110,y:420}, 'Witch':{x:0,y:500}, 'Duelist':{x:110,y:260}, 'Templar':{x:550,y:240}, 'Shadow':{x:550,y:80}, 'Reliquarian':{x:220,y:420}};
